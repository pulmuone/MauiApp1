...
public partial class OutlinedMaterialEntry : Grid
{
    ...
    public static readonly BindableProperty HasErrorProperty = BindableProperty.Create(
        ...
        (bindable, oldValue, newValue) =>
        {
            ...
            view.containerFrame.BorderColor = view.errorText.IsVisible ? Colors.Red : Colors.Black;

            view.helperText.IsVisible = !view.errorText.IsVisible;

            view.placeholderText.TextColor = view.errorText.IsVisible ? Colors.Red : Colors.Gray;
    ...
    public OutlinedMaterialEntry()
    {
        ...
        {
            this.containerFrame.BorderColor = this.HasError ? Colors.Red : this.BorderColor;
            this.placeholderText.TextColor = this.HasError ? Colors.Red : this.BorderColor;
        ...
        {
            this.containerFrame.BorderColor = this.HasError ? Colors.Red : Colors.Black;
            this.placeholderText.TextColor = this.HasError ? Colors.Red : Colors.Gray;
    ...
    public async void RePosition()
    {
        ...
        else
        {
            ...
            await this.placeholderContainer.TranslateTo(0, -20, 100, Easing.Linear); //위쪽으로 이동
    ...
    private async Task ControlFocused()
    {
        if (string.IsNullOrEmpty(this.customEntry.Text) || this.customEntry.Text.Length > 0)
        {
            ...
            int y = -20; //DeviceInfo.Platform == DevicePlatform.UWP ? -25 : -20;
